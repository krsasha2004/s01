...
public class VolleyLog {
    ...
    static class MarkerLog {
        ...
        public synchronized void finish(String header) {
            ...
            if (getTotalDuration() > 0) {
                ...
                VolleyLog.m0d("(%-4d ms) %s", Long.valueOf(duration), header);
                for (Marker marker : this.mMarkers) {
                    VolleyLog.m0d("(+%-4d) [%2d] %s", Long.valueOf(marker.time - prevTime), Long.valueOf(marker.thread), marker.name);
        ...
        protected void finalize() throws Throwable {
            if (!this.mFinished) {
                ...
                VolleyLog.m1e("Marker log finalized without finish() - uncaught exit point for request", new Object[0]);
            }
        }
    ...
    public static void m3v(String format, Object... args) {
        if (DEBUG) {
            buildMessage(format, args);
        }
    }

    public static void m0d(String format, Object... args) {
        buildMessage(format, args);
    }

    public static void m1e(String format, Object... args) {
        Log.e(TAG, buildMessage(format, args));
    }

    public static void m2e(Throwable tr, String format, Object... args) {
