...
import ru.steam.volley.DefaultRetryPolicy;
...
public class Endpoints {
    public static final String GENERAL_SEARCH_URL;
    public static final String GET_ACTIVE_MESSAGE_SESSIONS_SINCE_URL;
    public static final String GET_APP_SUMMARIES_URL;
    public static final String GET_GROUP_SUMMARIES_URL;
    public static final String GET_RECENT_MESSAGES_URL;
    public static final String GET_USER_FRIEND_LIST_URL;
    public static final String GET_USER_GROUP_LIST_URL;
    public static final String GET_USER_SUMMARIES_URL;
    public static final String MARK_OFFLINE_MESSAGES_READ_URL;
    public static final String MOBILEAUTH_BASE_URL;
    public static final String MOBILENOTIFICATION_BASE_URL;
    public static final String MOBILE_STOREFRONT_ACCOUNTDETAILS_CATEGORIES_URL;
    public static final String MOBILE_STOREFRONT_CATEGORIES_URL;
    public static final String MOBILE_STOREFRONT_INDEX_CATEGORIES_URL;
    public static final String SWITCH_TO_PUSH_URL;
    public static final String TWO_FACTOR_BASE_URL;
    public static final String UMQ_DEVICE_INFO_URL;
    public static final String UMQ_LOGOFF_URL;
    public static final String UMQ_LOGON_URL;
    public static final String UMQ_MESSAGE_REQ_URL;
    public static final String UMQ_POLL_FOR_MESSAGES_URL;
    public static final String UMQ_POLL_STATUS_URL;
    public static final String UMQ_SERVER_INFO_URL;

    static {
        UMQ_LOGON_URL = Config.URL_WEBAPI_BASE + "/ISteamWebUserPresenceOAuth/Logon/v0001";
        UMQ_LOGOFF_URL = Config.URL_WEBAPI_BASE + "/ISteamWebUserPresenceOAuth/Logoff/v0001";
        UMQ_MESSAGE_REQ_URL = Config.URL_WEBAPI_BASE + "/ISteamWebUserPresenceOAuth/Message/v0001";
        UMQ_SERVER_INFO_URL = Config.URL_WEBAPI_BASE + "/ISteamWebAPIUtil/GetServerInfo/v0001";
        UMQ_DEVICE_INFO_URL = Config.URL_WEBAPI_BASE + "/ISteamWebUserPresenceOAuth/DeviceInfo/v0001";
        UMQ_POLL_STATUS_URL = Config.URL_WEBAPI_BASE_INSECURE + "/ISteamWebUserPresenceOAuth/PollStatus/v0001";
        UMQ_POLL_FOR_MESSAGES_URL = Config.URL_WEBAPI_BASE + "/ISteamWebUserPresenceOAuth/Poll/v0001";
        GET_USER_SUMMARIES_URL = Config.URL_WEBAPI_BASE + "/ISteamUserOAuth/GetUserSummaries/v0001";
        GET_GROUP_SUMMARIES_URL = Config.URL_WEBAPI_BASE + "/ISteamUserOAuth/GetGroupSummaries/v0001";
        GET_APP_SUMMARIES_URL = Config.URL_WEBAPI_BASE + "/ISteamGameOAuth/GetAppInfo/v0001";
        GET_USER_GROUP_LIST_URL = Config.URL_WEBAPI_BASE + "/ISteamUserOAuth/GetGroupList/v0001";
        TWO_FACTOR_BASE_URL = Config.URL_WEBAPI_BASE + "/ITwoFactorService/%s/v0001";
        MOBILEAUTH_BASE_URL = Config.URL_WEBAPI_BASE + "/IMobileAuthService/%s/v0001";
        MOBILENOTIFICATION_BASE_URL = Config.URL_WEBAPI_BASE + "/IMobileNotificationService/%s/v0001";
        GET_USER_FRIEND_LIST_URL = Config.URL_WEBAPI_BASE + "/ISteamUserOAuth/GetFriendList/v0001";
        GENERAL_SEARCH_URL = Config.URL_WEBAPI_BASE + "/ISteamUserOAuth/Search/v0001";
        MOBILE_STOREFRONT_CATEGORIES_URL = Config.URL_STORE_BASE_INSECURE + "/api/mobilestorefrontcategories/v0001";
        MOBILE_STOREFRONT_INDEX_CATEGORIES_URL = Config.URL_STORE_BASE_INSECURE + "/api/mobilestorefrontindexcategories/v0001";
        MOBILE_STOREFRONT_ACCOUNTDETAILS_CATEGORIES_URL = Config.URL_STORE_BASE_INSECURE + "/api/mobilestorefrontaccountdetailscategories/v0001";
        GET_ACTIVE_MESSAGE_SESSIONS_SINCE_URL = Config.URL_WEBAPI_BASE + "/IFriendMessagesService/GetActiveMessageSessions/v0001";
        GET_RECENT_MESSAGES_URL = Config.URL_WEBAPI_BASE + "/IFriendMessagesService/GetRecentMessages/v0001";
        MARK_OFFLINE_MESSAGES_READ_URL = Config.URL_WEBAPI_BASE + "/IFriendMessagesService/MarkOfflineMessagesRead/v0001";
        SWITCH_TO_PUSH_URL = Config.URL_WEBAPI_BASE + "/IMobileNotificationService/SwitchSessionToPush/v0001";
    }
...
//        requestBuilder.appendKeyValue("lang", "russian");
